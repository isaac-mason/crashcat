...
export declare const ALL_SHAPE_DEFS: (import(".").ShapeDef<sphere.SphereShape> | import(".").ShapeDef<box.BoxShape> | import(".").ShapeDef<capsule.CapsuleShape> | import(".").ShapeDef<convexHull.ConvexHullShape> | import(".").ShapeDef<cylinder.CylinderShape> | import(".").ShapeDef<compound.CompoundShape> | import(".").ShapeDef<emptyShape.EmptyShape> | import(".").ShapeDef<offsetCenterOfMass.OffsetCenterOfMassShape> | import(".").ShapeDef<plane.PlaneShape> | import(".").ShapeDef<scaled.ScaledShape> | import(".").ShapeDef<staticCompound.StaticCompoundShape> | import(".").ShapeDef<transformed.TransformedShape> | import(".").ShapeDef<triangleMesh.TriangleMeshShape>)[];
