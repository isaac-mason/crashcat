...
export declare const ALL_SHAPE_DEFS: (import(".").ShapeDef<box.BoxShape> | import(".").ShapeDef<capsule.CapsuleShape> | import(".").ShapeDef<cylinder.CylinderShape> | import(".").ShapeDef<sphere.SphereShape> | import(".").ShapeDef<compound.CompoundShape> | import(".").ShapeDef<convexHull.ConvexHullShape> | import(".").ShapeDef<emptyShape.EmptyShape> | import(".").ShapeDef<offsetCenterOfMass.OffsetCenterOfMassShape> | import(".").ShapeDef<plane.PlaneShape> | import(".").ShapeDef<scaled.ScaledShape> | import(".").ShapeDef<staticCompound.StaticCompoundShape> | import(".").ShapeDef<transformed.TransformedShape> | import(".").ShapeDef<triangleMesh.TriangleMeshShape>)[];
