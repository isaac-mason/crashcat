...
import type { SupportFunctionMode } from '../collision/support.js';
import type { Face } from '../utils/face.js';
import type { BoxShape } from './box.js';
import type { CapsuleShape } from './capsule.js';
import type { CompoundShape } from './compound.js';
import type { ConvexHullShape } from './convex-hull.js';
import type { CylinderShape } from './cylinder.js';
import type { EmptyShape } from './empty-shape.js';
import type { OffsetCenterOfMassShape } from './offset-center-of-mass.js';
import type { PlaneShape } from './plane.js';
import type { ScaledShape } from './scaled.js';
import type { SphereShape } from './sphere.js';
import type { StaticCompoundShape } from './static-compound.js';
import type { TransformedShape } from './transformed.js';
import type { TriangleMeshShape } from './triangle-mesh.js';
/** base shape type */
