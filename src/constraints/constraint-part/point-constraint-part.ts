...
export type PointConstraintPart = {
	...
	/** whether this constraint part is active */
	active: boolean;
};
...
export function calculateConstraintProperties(
	...
	// invert to get effective mass (3x3 portion)
	const effectiveMass = mat4.invert(part.effectiveMass, invEffectiveMass);
...
export function solveVelocityConstraint(
	...
	// Note: This computes -J·v, so no negation needed (see Jolt's formula)
