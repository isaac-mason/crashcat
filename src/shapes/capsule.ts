...
function computeMassProperties(out: MassProperties, shape: CapsuleShape): void {
...
function getSurfaceNormal(ioResult: SurfaceNormalResult, shape: CapsuleShape, subShapeId: number): void {
...
function getSupportingFace(ioResult: SupportingFaceResult, direction: Vec3, shape: CapsuleShape, _subShapeId: number): void {
