...
import { createStandardWorld, LAYER_STATIC, makeRng, TIME_STEP } from './common';
...
// a scene where everything is static", so what this measures is the static broadphase tree's build
// cost plus whatever a step costs when there is no simulation work to do.
//
...
export const seaOfStaticBoxes = defineScenario({
    ...
    description: 'PEEL SeaOfStaticBoxes — 16384 static boxes, static broadphase build and idle step',
    steps: 60,
    create() {
